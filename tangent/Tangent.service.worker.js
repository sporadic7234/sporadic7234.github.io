...
/** @type {string} */
const CACHE_VERSION = '1760765487|7916858219';
/** @type {string} */
const CACHE_PREFIX = 'Tangent-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Tangent.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Tangent.html","Tangent.js","Tangent.offline.html","Tangent.icon.png","Tangent.apple-touch-icon.png","Tangent.audio.worklet.js","Tangent.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Tangent.wasm","Tangent.pck"];
